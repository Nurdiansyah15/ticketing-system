...
@section('content')
    <div class="container py-4">
        ...
        ">
            <h1 class="text-center" style="color: #fff; font-weight: bold;">Tambah Pengguna</h1>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="role" class="form-control"
                        style="background-color: transparent; border: 1px solid #fff; color: white;" required>
                        <option value="admin" style="background-color: #333; color: white;">Admin</option>
                        <option value="user" style="background-color: #333; color: white;">User</option>
                    </select>
                </div>
